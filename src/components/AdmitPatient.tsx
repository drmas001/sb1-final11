  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
          <label htmlFor="name" className="block text-gray-700 text-sm font-bold mb-2">Patient Name</label>
          <input
            type="text"
            id="name"
            value={name}
        ...
        <div className="mb-4">
          <label htmlFor="mrn" className="block text-gray-700 text-sm font-bold mb-2">MRN (Medical Record Number)</label>
          <input
            type="text"
            id="mrn"
            value={mrn}
        ...
        <div className="mb-4">
          <label htmlFor="diagnosis" className="block text-gray-700 text-sm font-bold mb-2">Diagnosis</label>
          <input
            type="text"
            id="diagnosis"
            value={diagnosis}
